      ...
      <div className={classes.root}>
        ...
        >
          <div className={classes.list} role="presentation">
            ...
            <Accordion
              square
              expanded={this.state.expandTags}
              onChange={() => {
            ...
            >
              <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="tags-content" id="tags-header">
              ...
              <AccordionDetails>
                <List className={classes.listParent}>
                  {this.props.label
                    ...
                    .map((arr, i) => (
                      <Link color="inherit" underline="none" href={'/search/label/' + arr.term} component="a" key={i}>
